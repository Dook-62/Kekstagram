...
const names = ['Артем','Олег','Артур','Марина','Ольга','Константин','Джон','Илья','Максим',];

//Создание текста сообщения для комментарий
const createMessage = () =>
  Array.from({ length: getRandomPositiveInteger(1, 2) }, () =>
    getRandomArrayElement(commentLines)
  ).join(' ');

//Функция, создающая объект с полями, описывающие комментарий
...
//Создание объекта, описывающего поля фотографии
